...
import com.example.copyhomet.Camera.*
 ...
 */
class Camera2BasicFragment : Fragment(), androidx.legacy.app.FragmentCompat.OnRequestPermissionsResultCallback {
...
//    stopBackgroundThread()
  ...
  private fun setUpCameraOutputs(
    ...
    //카메라 전후면
        val pref = context.getSharedPreferences("info",Context.MODE_PRIVATE)
        val cameraIndex : String = pref.getString("cameraIndex","front")!!

        val a :String =cameraIndex
//        if(cameraIndex.equals("front")) {
...
//          }
  ...
  private fun openCamera(
    ...
    if (!checkedPermissions && !allPermissionsGranted()) {
      androidx.legacy.app.FragmentCompat.requestPermissions(this, requiredPermissions, PERMISSIONS_REQUEST_CODE)
      return
    } else {
...
//        val drawable = activity.getDrawable(R.drawable.aaa1234)
...
//    }
  ...
  companion object {
    ...
    const val HANDLE_THREAD_NAME = "CameraBackground"
    ...
    fun chooseOptimalSize(
      ...
      // Pick the smallest of those big enough. If there is no one big enough, pick thef

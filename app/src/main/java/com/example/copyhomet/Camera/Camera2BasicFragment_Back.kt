...
package com.jinasoft.hometuser.Camera
 ...
 */
class Camera2BasicFragment_Back : Fragment(), androidx.legacy.app.FragmentCompat.OnRequestPermissionsResultCallback {
...
//        }
  ...
  /**
   * Opens the camera specified by [Camera2BasicFragment_Back.cameraId].
   */
...
//    Log.d("empty","empty")
  ...
  companion object {
    ...
    fun newInstance(): Camera2BasicFragment_Back {
      return Camera2BasicFragment_Back()
    }
  }
}
